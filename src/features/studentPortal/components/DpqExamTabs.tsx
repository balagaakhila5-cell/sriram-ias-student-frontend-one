...
type DpqExam = "prelims" | "mains";

interface DpqExamTabsProps {
  activeTab: DpqExam;
  onChange: (tab: DpqExam) => void;
  className?: string;
}
...
/** Prelims / Mains tabs — same style as Study Materials portal tabs */
export default function DpqExamTabs({
  activeTab,
  onChange,
  className = "",
}: DpqExamTabsProps) {
  const tabs: { id: DpqExam; label: string }[] = [
