...
export default function NextClassCard({
  ...
  return (
    <div className="overflow-hidden rounded-[20px] bg-white shadow-[0_10px_30px_rgba(0,0,0,0.06)]">
      ...
      <div
        className="relative overflow-hidden bg-no-repeat p-5"
        style={{
          backgroundImage:
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <div className="mt-3 flex items-center gap-2 text-[16px] font-semibold text-black/50">
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
            ...
            <span className="leading-none text-black/80">
              {session.timeLabel} | {session.dateLabel}
            </span>
          </div>

          <div className="mt-3 flex items-center gap-x-6 gap-y-2 overflow-hidden text-[16px] font-semibold text-black/50">
            ...
            <span className="flex items-center gap-2 whitespace-nowrap text-[16px] font-semibold text-black/50">
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
