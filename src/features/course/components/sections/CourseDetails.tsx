      ...
      <div ref={containerRef} className="w-full flex flex-col font-['Montserrat',sans-serif] bg-white">
        ...
        >
          ...
          <div className="max-w-[1400px] mx-auto relative z-10 px-6 md:px-12 lg:px-20">
            ...
            <div className="flex flex-col items-end gap-8 md:flex-row md:gap-6 lg:gap-8">
              ...
              <div className="course-details-image relative -ml-2 flex w-full shrink-0 justify-center md:-ml-6 md:w-[34%] md:justify-start lg:-ml-8 lg:w-[32%]">
                ...
                <img
                  ...
                  className="relative z-10 -mb-1 block h-auto w-full max-w-[380px] object-contain object-bottom lg:max-w-[500px]"
                />
              </div>

              {/* RIGHT Side: Highlights only */}
              <div className="z-10 min-w-0 flex-1 pb-12 pr-2 md:pb-24 md:pr-6">
                <ul className="m-0 grid list-none grid-cols-1 gap-x-10 gap-y-5 p-0 lg:grid-cols-2 lg:gap-x-12 xl:gap-x-16">
                  {displayHighlights.map((highlight, index) => (
                    <li key={index} className="highlight-item flex min-w-0 items-start gap-4 md:gap-5">
                      <span className={`mt-2 h-[6px] w-[6px] shrink-0 rounded-full ${bulletColor}`} />
                      <span className="text-[14px] font-semibold leading-snug tracking-wide text-[#000000B2] md:text-[17px] lg:text-[18px]">
                        {highlight}
                      </span>
                    </li>
                  ))}
            ...
            <div className="flex flex-col md:flex-row items-end justify-between gap-8 lg:gap-12">
              ...
              <div className="w-full md:w-[65%] lg:w-[70%] pb-12 md:pb-24 z-10">
                <ul className="grid grid-cols-1 xl:grid-cols-2 gap-y-6 gap-x-36 list-none p-0 m-0">
                  {displayHighlights.map((highlight, index) => (
                    <li key={index} className="highlight-item flex items-center gap-4 md:gap-5">
