...
const Hero: React.FC<Props> = ({ city }) => {
  ...
  return (
    <section ref={containerRef} className="relative flex h-screen min-h-screen w-full flex-col justify-center px-4 pb-12 pt-[88px] text-left md:px-8 md:pb-16 lg:px-16">
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1440px]">
        <h1 className="center-hero-title mb-6 font-['Montserrat'] text-[42px] font-[900] leading-tight text-white md:mb-8 md:text-[46px] lg:text-[48px]">
          Welcome to <span className="text-[#A2A4FB]">{cityName}</span>
        </h1>

        <div className="center-hero-contact flex flex-col items-start justify-start gap-4 font-['Montserrat'] text-[18px] font-bold text-white sm:flex-row sm:gap-10 md:text-[20px]">
          <PhoneLink
            value={branchContact.phone}
            className="flex items-center gap-4 hover:underline"
          >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg" aria-hidden>
