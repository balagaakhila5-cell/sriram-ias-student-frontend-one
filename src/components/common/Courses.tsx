...
const Courses = () => {
  return (
    <div className="rounded-[22px] bg-white bg-[url('/assets/free-resources/courses-bg.png')] bg-cover bg-center p-4 shadow-[0px_10px_30px_rgba(0,0,0,0.05)]">
      <h2 className="mb-4 text-center text-[34px] font-extrabold leading-none">
