    ...
    <div ref={containerRef} className="relative z-[100]">
      ...
      <div className="floating-whatsapp fixed bottom-10 right-4 z-60 sm:bottom-12 sm:right-6">
        <a
          ...
          className={`flex flex-row-reverse items-center overflow-hidden rounded-full transition-all duration-500 ease-in-out ${
            showWhatsAppText
              ? 'max-w-[300px] gap-2.5 border border-[#C8EBD2] bg-[#EAF7EE] py-2 pl-3 pr-2 shadow-[0_8px_28px_rgba(0,0,0,0.12)] max-[399px]:max-w-[3rem] max-[399px]:gap-0 max-[399px]:border-0 max-[399px]:bg-transparent max-[399px]:p-0 max-[399px]:shadow-none sm:gap-3 sm:pl-4 sm:pr-2'
              : 'max-w-[3rem] p-0 shadow-none sm:max-w-[3.5rem]'
          }`}
        >
          <div className="relative z-10 flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[#25D366] shadow-[0_4px_14px_rgba(37,211,102,0.35)] sm:h-12 sm:w-12">
            <svg
          ...
          <div
            className={`hidden min-w-0 overflow-hidden transition-all duration-500 ease-in-out min-[400px]:block ${
              showWhatsAppText
                ? 'max-w-[220px] opacity-100'
                : 'max-w-0 opacity-0'
            }`}
          >
            <p className="whitespace-nowrap font-['Montserrat'] text-[13px] font-bold leading-tight text-[#1F2937] sm:text-[14px]">
              Got any Queries?
            </p>
            <p className="mt-0.5 font-['Montserrat'] text-[10px] font-medium leading-snug text-[#6B7280] sm:text-[11px]">
