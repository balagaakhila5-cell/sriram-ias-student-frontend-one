  ...
  <div className="relative z-10 mx-auto flex max-w-[1300px] flex-col items-center justify-between gap-8 px-4 pt-10 sm:px-6 md:px-12 md:pt-16 lg:flex-row lg:items-stretch lg:gap-12 lg:px-20">
    <div className="z-10 flex w-full flex-col justify-center pb-8 text-center md:pb-12 lg:text-left">
      ...
      <form className="mx-auto w-full max-w-[640px] lg:mx-0">
        <div className="mb-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          <div className="relative w-full">
            <select
              name="targetYear"
              defaultValue=""
              className="w-full cursor-pointer appearance-none rounded-3xl border-none bg-white px-4 py-3.5 text-center text-[16px] font-medium text-gray-500 shadow-sm outline-none transition-all focus:ring-2 focus:ring-blue-300"
            >
        ...
        <label className="group mt-2 mb-8 flex cursor-pointer items-start gap-3 text-left">
          <input
            type="checkbox"
          ...
          <span className="text-[12px] font-medium leading-[1.6] text-[#00000099]">
            I authorize SRIRAM&apos;s IAS and its associates to contact me with
    ...
    <div className="relative z-10 flex w-full justify-center lg:self-end lg:justify-end">
      <div className="relative flex origin-bottom scale-[0.9] items-end justify-center -mb-1 sm:scale-100 md:scale-[1.1] lg:scale-[1.35]">
        <img
          src="/assets/course/cta-img.png"
          alt="Professional man"
          className="relative z-10 w-[220px] object-contain object-bottom drop-shadow-xl sm:w-[280px] md:w-[380px] lg:w-[650px] lg:-ml-[-30%]"
        />
