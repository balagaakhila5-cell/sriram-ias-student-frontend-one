...
export default function DpqTestLeaderboardLoading() {
  return (
    <>
      <HeaderLogoOnly />
      <main className="min-h-screen bg-[#F8F9FB] px-4 py-10 sm:px-6 lg:px-8">
        <div className="mx-auto w-full max-w-[980px]">
          <div className="mb-8 h-5 w-[200px] animate-pulse rounded-full bg-[#EDEEF2]" />
          <div className="mb-8 mx-auto h-10 w-[320px] animate-pulse rounded-full bg-[#EDEEF2]" />
